"""QuickBooks Online connector - not implemented yet.
...
When implemented it needs: OAuth 2.0 with a refresh token; Reports and Journal Entries endpoints.
...
IMPLEMENTED = False
NOTES = "OAuth 2.0 with a refresh token; Reports and Journal Entries endpoints"
